...
public class Donate extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigationMyProfile:
                    Intent profile=new Intent(Donate.this,ProfileActivity.class);
                    startActivity(profile);
                    //overridePendingTransition(R.anim.fadein,R.anim.anim);
                    finish();
                    return true;
                case R.id.navigationMyCourses:
                    Intent help=new Intent(Donate.this,HELPsection.class);
                    startActivity(help);
                 //   overridePendingTransition(R.anim.leftanim,R.anim.anim);
                    finish();
                    return true;
                case R.id.navigationHome:
                    Intent home=new Intent(Donate.this,MainActivity2.class);
                    startActivity(home);
                   // overridePendingTransition(R.anim.leftanim,R.anim.anim);
                    finish();
                    return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window = Donate.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(Donate.this, R.color.statusbar));
        window.setNavigationBarColor(ContextCompat.getColor(Donate.this, R.color.statusbar));

        Imagedonate = findViewById(R.id.donateupload);

        storage=FirebaseStorage.getInstance();
        storageReference=storage.getReference();
        storageReference=FirebaseStorage.getInstance().getReference().child("uploadpictures/donatepicture.png");


        try{
            final File localfile=File.createTempFile("donatepicture","png");
        ...
        CardView food=findViewById(R.id.donateFood);

        food.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String givefood="Food";
                Intent food=new Intent(Donate.this,giverfood.class);
        ...
        /*CardView cloth=findViewById(R.id.donatecloth);
        cloth.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String givecloth="Clothes";
                Intent cloth=new Intent(Donate.this,givercloth.class);
        ...
        CardView blanket=findViewById(R.id.donateblanket);
        blanket.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String giveblanket="Old Newspapers";
                Intent blanket=new Intent(Donate.this,giverblanket.class);
        ...
        CardView blood=findViewById(R.id.donateblood);
        blood.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String givebood="Blood";
                Intent blood=new Intent(Donate.this,giverblood.class);
        ...
        CardView study=findViewById(R.id.donatestudy);
        study.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String givestudy="Educational";
                Intent study=new Intent(Donate.this,giverstudy.class);
        ...
        CardView others=findViewById(R.id.donateother);
        others.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent others=new Intent(Donate.this,Typeyourown.class);
        ...
        sack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent sack=new Intent(Donate.this,giversack.class);
...
//
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent gotohome=new Intent(Donate.this,MainActivity2.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_faq) {
            ...
            Intent timeline=new Intent(Donate.this,Timeline.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        try {
            ...
            Toast.makeText(Donate.this, ex.toString(),
