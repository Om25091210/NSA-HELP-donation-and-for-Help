...
public class Descriptionsectionblood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_descriptionsectionblood);
        ...
        Window window = Descriptionsectionblood.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(Descriptionsectionblood.this, R.color.statusbar));
        window.setNavigationBarColor(ContextCompat.getColor(Descriptionsectionblood.this, R.color.statusbar));
        ...
        savedesc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!getdescriptionfromtext.equals("") && getdescriptionfromtext.length()<=900){
                    Intent senddesc=new Intent(Descriptionsectionblood.this,giverblood.class);
