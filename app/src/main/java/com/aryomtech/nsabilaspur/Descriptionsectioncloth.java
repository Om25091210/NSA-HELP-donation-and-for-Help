...
public class Descriptionsectioncloth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_descriptionsectioncloth);
        ...
        Window window = Descriptionsectioncloth.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(Descriptionsectioncloth.this, R.color.statusbar));
        window.setNavigationBarColor(ContextCompat.getColor(Descriptionsectioncloth.this, R.color.statusbar));
        ...
        savedesc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!getdescriptionfromtext.equals("") && getdescriptionfromtext.length()<=900){
                    Intent senddesc=new Intent(Descriptionsectioncloth.this,givercloth.class);
