...
public class Descriptionsection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_descriptionsection);
        ...
        Window window = Descriptionsection.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(Descriptionsection.this, R.color.statusbar));
        window.setNavigationBarColor(ContextCompat.getColor(Descriptionsection.this, R.color.statusbar));
        ...
        savedesc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!getdescriptionfromtext.equals("") && getdescriptionfromtext.length()<=900){
                    Intent senddesc=new Intent(Descriptionsection.this,giverblanket.class);
