...
public class HolderPickup extends RecyclerView.ViewHolder {
    ...
    public HolderPickup(@NonNull View itemView) {
        super(itemView);
    ...
    public void setView(Context context, String category, String naam, String address, String phoneno, String haveName, String uid,String description,String type,
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                refH.child(user.getUid()).child(user.getDisplayName()).child("ConfirmId").child(userdonorid).removeValue();
            ...
            public void onClick(View v) {
                ...
                confirmtick.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        refH=databaseH.getReference().child("Users");
                        refH.child(user.getUid()).child(user.getDisplayName()).child("ConfirmId").child(userdonorid).child("done").setValue("yes");
                        ...
                        reffordonors.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                ref_for_Donors_data.child(donorsuid).child("ConfirmDonation").child(userdonorid).child("done").setValue("yes");
                            }
